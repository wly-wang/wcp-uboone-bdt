...
#include "init.txt"
  ...
  if (T_BDTvars_cv->GetBranch("numu_1_score")) T_BDTvars_cv->SetBranchStatus("numu_1_score",1);

  if (T_BDTvars_cv->GetBranch("numu_cc_3_track_length")) T_BDTvars_cv->SetBranchStatus("numu_cc_3_track_length",1);

  if (T_BDTvars_cv->GetBranch("numu_cc_3_max_length_all")) T_BDTvars_cv->SetBranchStatus("numu_cc_3_max_length_all",1);

  if (T_BDTvars_cv->GetBranch("cosmict_2_dQ_dx_front")) T_BDTvars_cv->SetBranchStatus("cosmict_2_dQ_dx_front",1);

  if (T_BDTvars_cv->GetBranch("cosmict_2_dQ_dx_end")) T_BDTvars_cv->SetBranchStatus("cosmict_2_dQ_dx_end",1);

  if (T_BDTvars_cv->GetBranch("cosmict_2_angle_beam")) T_BDTvars_cv->SetBranchStatus("cosmict_2_angle_beam",1);

  if (T_BDTvars_cv->GetBranch("cosmict_2_phi")) T_BDTvars_cv->SetBranchStatus("cosmict_2_phi",1);

  if (T_BDTvars_cv->GetBranch("numu_cc_3_max_length")) T_BDTvars_cv->SetBranchStatus("numu_cc_3_max_length",1);

  if (T_BDTvars_cv->GetBranch("numu_cc_3_max_muon_length")) T_BDTvars_cv->SetBranchStatus("numu_cc_3_max_muon_length",1);
  ...
  T_BDTvars_det->SetBranchStatus("spt_angle_vertical",1);
   ...
   if (T_BDTvars_det->GetBranch("numu_1_score")) T_BDTvars_det->SetBranchStatus("numu_1_score",1);

   if (T_BDTvars_det->GetBranch("numu_cc_3_track_length")) T_BDTvars_det->SetBranchStatus("numu_cc_3_track_length",1);

   if (T_BDTvars_det->GetBranch("numu_cc_3_max_length_all")) T_BDTvars_det->SetBranchStatus("numu_cc_3_max_length_all",1);

   if (T_BDTvars_det->GetBranch("cosmict_2_dQ_dx_front")) T_BDTvars_det->SetBranchStatus("cosmict_2_dQ_dx_front",1);

   if (T_BDTvars_det->GetBranch("cosmict_2_dQ_dx_end")) T_BDTvars_det->SetBranchStatus("cosmict_2_dQ_dx_end",1);

   if (T_BDTvars_det->GetBranch("cosmict_2_angle_beam")) T_BDTvars_det->SetBranchStatus("cosmict_2_angle_beam",1);

   if (T_BDTvars_det->GetBranch("cosmict_2_phi")) T_BDTvars_det->SetBranchStatus("cosmict_2_phi",1);

   if (T_BDTvars_det->GetBranch("numu_cc_3_max_length")) T_BDTvars_det->SetBranchStatus("numu_cc_3_max_length",1);

   if (T_BDTvars_det->GetBranch("numu_cc_3_max_muon_length")) T_BDTvars_det->SetBranchStatus("numu_cc_3_max_muon_length",1);
